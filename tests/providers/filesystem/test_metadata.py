...
class TestMetadata:
    ...
    def test_file_metadata(self, fs):
        ...
        assert json_api_data['links']['info'] == 'http://localhost:7777/filesystem/test.txt?serve=meta'
        assert json_api_data['links']['delete'] == 'http://localhost:7777/filesystem/test.txt?serve=delete'
        assert json_api_data['links']['download'] == 'http://localhost:7777/filesystem/test.txt?serve=download'
    ...
    def test_root_metadata(self, fs):
        ...
        assert json_api_data['links']['info'] == 'http://localhost:7777/filesystem/?serve=meta'
        assert json_api_data['links']['delete'] == 'http://localhost:7777/filesystem/?serve=delete'
        assert json_api_data['links']['download_as_zip'] == 'http://localhost:7777/filesystem/?serve=download_as_zip'
        assert json_api_data['links']['upload'] == 'http://localhost:7777/filesystem/?serve=upload'
        assert json_api_data['links']['children'] == 'http://localhost:7777/filesystem/?serve=children'
    ...
    def test_folder_metadata(self, fs):
        ...
        assert json_api_data['links']['info'] == 'http://localhost:7777/filesystem/folder%20test/?serve=meta'
        assert json_api_data['links']['delete'] == 'http://localhost:7777/filesystem/folder%20test/?serve=delete'
        assert json_api_data['links']['download_as_zip'] == 'http://localhost:7777/filesystem/folder%20test/?serve=download_as_zip'
        assert json_api_data['links']['upload'] == 'http://localhost:7777/filesystem/folder%20test/?serve=upload'
        assert json_api_data['links']['children'] == 'http://localhost:7777/filesystem/folder%20test/?serve=children'
