...
from aquavalet.providers.dataverse.metadata import DataverseRevision
from aquavalet.providers.dataverse.metadata import DataverseDatasetMetadata
...
class DataverseProvider(provider.BaseProvider):
    ...
    * Dataverse doesn't respect Range header on downloads
    ...
    async def upload(self, stream, path, **kwargs):
        ...
        :param aquavalet.core.streams.RequestWrapper stream: The stream to put to Dataverse
