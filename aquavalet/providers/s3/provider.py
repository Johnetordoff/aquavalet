...
from aquavalet.providers.s3.metadata import S3FileMetadata
from aquavalet.providers.s3.metadata import S3FolderMetadata
from aquavalet.providers.s3.metadata import S3FolderKeyMetadata
from aquavalet.providers.s3.metadata import S3FileMetadataHeaders
...
class S3Provider(provider.BaseProvider):
    ...
    * A GET prefix query against a non-existent path returns 200
    ...
    async def download(self, path, accept_url=False, revision=None, range=None, **kwargs):
        ...
        :raises: :class:`aquavalet.core.exceptions.DownloadError`
        """
        await self._check_region()
    ...
    async def upload(self, stream, path, conflict='replace', **kwargs):
        ...
        :param aquavalet.core.streams.RequestWrapper stream: The stream to put to S3
