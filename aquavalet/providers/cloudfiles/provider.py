...
from aquavalet.providers.cloudfiles.metadata import CloudFilesFolderMetadata
from aquavalet.providers.cloudfiles.metadata import CloudFilesHeaderMetadata
