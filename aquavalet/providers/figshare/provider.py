...
from aquavalet.providers.figshare import metadata, settings
...
class FigshareProvider:
    ...
    **On paths:**  Figshare does not have any notion of paths and has a very flat structure. Top
    ...
    a private 'collection' as the root of a aquavalet provider instance. The FigshareProvider's
...
class FigshareProjectProvider(BaseFigshareProvider):
    ...
    async def create_folder(self, path, **kwargs):
        ...
        :rtype: :class:`aquavalet.core.metadata.FigshareFolderMetadata`
        :raises: :class:`aquavalet.core.exceptions.CreateFolderError`
        """
